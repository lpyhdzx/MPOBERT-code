...
class DeepspeedArguments:
    ...
    deepspeed: bool = field(default=False, metadata={"help": "Use deepspeed."})

    deepspeed_transformer_kernel: bool = field(
        default=False, metadata={"help": "Use DeepSpeed transformer kernel to accelerate."}
    )

    stochastic_mode: bool = field(
        default=False,
        metadata={
    ...
    attention_dropout_checkpoint: bool = field(
        default=False,
        metadata={
    ...
    normalize_invertible: bool = field(
        default=False,
        metadata={
    ...
    gradient_predivide_factor: int = field(
        default=None, metadata={"help": "gradient predivide factor"}
    )

    fp16: bool = field(default=False, metadata={"help": "Enable FP16 training"})
    ...
    fp16_opt: str = field(default="O2", metadata={"help": "Apex optimization level"})
