...
class SchedulerArgs:
    ...
    warmup_proportion: float = field(default=0.06, metadata={"help": "Warmup proportion"})
    decay_rate: float = field(default=0.99, metadata={"help": "Decay rate"})
    decay_step: int = field(default=1000, metadata={"help": "Decay step"})
